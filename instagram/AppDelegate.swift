...
//  instagram
//
//  Created by Nicole Hipolito on 2/19/18.
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        Parse.initialize(
            with: ParseClientConfiguration(block: { (configuration: ParseMutableClientConfiguration) -> Void in
                ...
                configuration.clientKey = "enaflkjdfiengsakdjflewk"  // set to nil assuming you have not set clientKey
                configuration.server = "https://fierce-taiga-26363.herokuapp.com/parse"
            })
        )
